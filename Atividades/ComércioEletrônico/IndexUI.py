...
class IndexUI:
    def menu_visitante():
        op = st.sidebar.selectbox("Menu", ["Criar conta", "Entrar no sistema"])
        if op == "Criar conta":
            AbrirConta.main()
    ...
    def menu_admin():
        op = st.sidebar.selectbox("Menu", ["Cadastro de Clientes", "Cadastro de Categorias", "Cadastro de Produtos"])
    ...
    def menu_cliente():
        op = st.sidebar.selectbox("Menu", ["Inserir produtos ao carrinho", "Listar produtos", "Fechar pedido", "Ver meus pedidos"])
